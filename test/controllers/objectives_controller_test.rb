...
class ObjectivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post objectives_url, params: { objective: { code: @objective.code, description: @objective.description, project_id: @objective.project_id } }
    end
  ...
  test "should update objective" do
    patch objective_url(@objective), params: { objective: { code: @objective.code, description: @objective.description, project_id: @objective.project_id } }
